...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/western-woman-having-teatime-cafe-udaipur_53876-65359.jpg",
          imageAlt: "Luxury Rooftop Ambiance",
        },
        {
          ...
          imageAlt: "City Lights View",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/spoon-fork-with-red-flower-napkin_23-2147990899.jpg",
      ...
      features={[
        {
          ...
          description: "Precision-engineered dishes using globally sourced ingredients.",
          imageSrc: "http://img.b2bpic.net/free-photo/professional-chef-preparing-food-kitchen_23-2149728015.jpg",
          imageAlt: "Fine Dining Kitchen",
        },
        {
          title: "Panoramic Rooftop",
          description: "Stunning views of the DHA skyline paired with curated atmosphere.",
          imageSrc: "http://img.b2bpic.net/free-photo/lamb-bone-covered-with-dough-finely-cooked_114579-2429.jpg",
          imageAlt: "Plated Perfection",
        },
        {
          title: "Refined Hospitality",
          description: "Service designed to ensure a seamless, luxurious evening.",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          imageAlt: "Wagyu Burger",
        },
        {
          id: "3",
          name: "Gold Leaf Chocolate Lava",
          price: "PKR 1,800",
          imageSrc: "http://img.b2bpic.net/free-photo/delicious-ice-cream-winter-time_23-2149618913.jpg",
          imageAlt: "Luxury Dessert",
        },
        {
          id: "4",
          name: "Hibiscus Infusion Mocktail",
          price: "PKR 1,200",
          imageSrc: "http://img.b2bpic.net/free-photo/still-life-sotol-drink-with-ingredients_52683-148472.jpg",
          imageAlt: "Signature Mocktail",
        },
        {
          id: "5",
          name: "Seared Scallops Trio",
          price: "PKR 2,500",
          ...
          imageAlt: "Gourmet Appetizer",
        },
        {
          id: "6",
          name: "Artisan Roasted Espresso",
          price: "PKR 850",
      ...
      bulletPoints={[
        {
          ...
          description: "Farm-to-table freshness redefined.",
        },
        {
          title: "Modern Atmosphere",
          description: "Designed for intimate moments and professional engagement.",
        },
        {
          title: "Seamless Ordering",
          description: "Effortless process for direct online orders.",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Sarah Mansoor",
          role: "Food Critic",
          testimonial: "An unparalleled rooftop experience in DHA. The attention to detail is remarkable.",
        ...
        },
        {
          ...
          name: "Ali Khan",
          role: "Architect",
          testimonial: "The atmosphere is unmatched in Karachi. Modern, sleek, and perfect for meetings.",
        ...
        },
        {
          ...
          name: "Zoya Ahmed",
          role: "Entrepreneur",
          testimonial: "Seamless booking and the finest steak I've had in the city. Truly premium.",
        ...
        },
        {
          ...
          name: "Omar Farooq",
          role: "Local Resident",
          testimonial: "My go-to place for date nights. Aura Rooftop redefined luxury dining.",
        ...
        },
        {
          ...
          name: "Sara H.",
          role: "Socialite",
          testimonial: "The desserts are pieces of art. Truly a world-class experience.",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-kissing-man-forehead-restaurant_23-2148014524.jpg",
        },
      ]}
  ...
  <div id="gallery" data-section="gallery">
      ...
      features={[
        {
          title: "City Skyline",
          description: "Night view of Clifton",
          imageSrc: "http://img.b2bpic.net/free-photo/tower-landmarks-famous-skyscrapers-pearl_1417-298.jpg",
          imageAlt: "City View",
        },
        {
          title: "Tables",
        ...
        {
          title: "Art",
          description: "Fine dining plates",
      ...
      faqs={[
        {
          ...
          content: "Located centrally in the Clifton/DHA area with valet parking available for your convenience.",
        },
        {
          id: "2",
          title: "What are your operating hours?",
          content: "We welcome you daily from 6:00 PM until 1:00 AM.",
        },
        {
          id: "3",
          title: "Do you offer delivery?",
          content: "Yes, premium delivery service is available for our curated selection.",
        },
        {
          id: "4",
          title: "Is parking available?",
          content: "Valet services are provided on-site to ensure your arrival is as smooth as your experience.",
        },
      ]}
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "DHA Phase 6, Clifton, Karachi",
            },
          ],
        },
        {
          ...
          items: [
            {
              label: "+92 (21) 123-4567",
              href: "tel:+92211234567",
            },
            {
              label: "info@aurarooftop.pk",
              href: "mailto:info@aurarooftop.pk",
            },
          ],
        },
        {
